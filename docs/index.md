# Cody Newman SNHU Computer Science
...
The artifacts presented in this portfolio will specifically demonstrate my proficiency in software engineering, data structures and algorithms, and databases. Using a MEAN stack web app built for my Full-Stack Development course, I've implemented a role-based access control system to the app's API, a search function for the app's display content, and migrated the database from a mongo-db database to use a sqlite database. 
